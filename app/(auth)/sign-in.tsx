        ...
        <SafeAreaView className="flex-1 bg-[#FCF9E8]">
            <View className="flex-1 items-center justify-center">
                ...
                <TouchableOpacity
                    ...
                    className="mt-5 w-[50%] rounded-full border border-[#747775] bg-[#FFFFFF] py-3 shadow-zinc-300"
                    activeOpacity={0.7}
                >
                    <View className="flex flex-row items-center justify-center">
                        <Image
                            ...
                            resizeMode="contain"
                        />
                        <Text className="font-roboto-medium text-black-300 text- ml-2">Continue with Google</Text>
                    </View>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
